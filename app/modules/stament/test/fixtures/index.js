...
const deleteDeep = { "videos": [{"_id":3, "another": [{"_id":5, "haters":[{"_id":7, "_delete":true}]}] }] }



module.exports = {original, singleAdd, addDeep, wrongAdd, singleUpdate, updateDeep, singleDelete, deleteDeep}